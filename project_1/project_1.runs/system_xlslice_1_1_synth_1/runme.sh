...
HD_PWD='/home/golfit/git/fpga-stopwatch/project_1/project_1.runs/system_xlslice_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlslice_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlslice_1_1.tcl
